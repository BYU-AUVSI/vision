...
(cl:defmethod cl:initialize-instance :after ((m <IntList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name click_to_geolocate-msg:<IntList> is deprecated: use click_to_geolocate-msg:IntList instead.")))
